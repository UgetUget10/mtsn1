...
class RedirectResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Pengalihan URL';

    protected static ?string $modelLabel = 'Pengalihan';

    protected static ?string $pluralModelLabel = 'Pengalihan URL';
